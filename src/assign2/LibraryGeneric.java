...
public class LibraryGeneric<Type> {
	...
	public ArrayList<LibraryBookGeneric<Type>> lookup(Type holder) {
		//Creates an empty arrayList to contain books checked out by this holder
	...
	public ArrayList<LibraryBookGeneric<Type>> getOverdueList(int month, int day, int year) {
		...
		//Creates an empty list to contain all overdue books.
		ArrayList<LibraryBookGeneric<Type>> overdueList = new ArrayList<LibraryBookGeneric<Type>>();

		for (LibraryBookGeneric<Type> element : library) {
			if (element.getDueDate() != null && element.getDueDate().before(tempDate))
				overdueList.add(element);
		}
	...
	public ArrayList<LibraryBookGeneric<Type>> getOrderedByAuthor() {
		ArrayList<LibraryBookGeneric<Type>> allBooks = library;
		
		OrderByAuthor comparator = new OrderByAuthor();
		sort(allBooks, comparator);
		return allBooks;
	}
	...
	/**
	 * Comparator that defines an ordering based on alphabetical order of the
	 * authors.
	 */
